...
const ModalBoletaPago: React.FC<ModalProps> = ({ show, onClose,  children }) => {
    if (!show) {
        return null;
    }
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-full bg-[rgba(0, 0, 0, 0.5)] flex items-center justify-center backdrop-blur-sm" onClick={handleBackgroundClick}>
            <div className="bg-slate-900 rounded-md max-w-[1050px] w-full px-5 pb-5 pt-1 shadow-[0 5px 15px rgba(0, 0, 0, 0.3)]">
...
export default ModalBoletaPago;
